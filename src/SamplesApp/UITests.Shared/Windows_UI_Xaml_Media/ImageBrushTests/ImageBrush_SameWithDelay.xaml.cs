...
namespace UITests.Shared.Windows_UI_Xaml_Media.ImageBrushTests
{
	...
	public sealed partial class ImageBrush_SameWithDelay : UserControl
	{
		...
		public ImageBrush_SameWithDelay()
		{
			...
			Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, () => _ctx.ImgSource = "http://lh5.ggpht.com/lxBMauupBiLIpgOgu5apeiX_YStXeHRLK1oneS4NfwwNt7fGDKMP0KpQIMwfjfL9GdHRVEavmg7gOrj5RYC4qwrjh3Y0jCWFDj83jzg");

			imageBrush.ImageOpened += (s, e) => { 
				_ctx.ImgSource2 = "http://lh5.ggpht.com/lxBMauupBiLIpgOgu5apeiX_YStXeHRLK1oneS4NfwwNt7fGDKMP0KpQIMwfjfL9GdHRVEavmg7gOrj5RYC4qwrjh3Y0jCWFDj83jzg";
		   };
		}
	}
